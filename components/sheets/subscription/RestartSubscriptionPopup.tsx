...
const RestartSubscriptionPopup: React.FC<IProps> = ({ data }) => {
	...
	const optOutDisabled = data === CONSTANTS.SUBSCRIPTION_TYPES.CANCELLED_ENDED;
	const handlePopUp = () => {
		...
		<View style={styles.subscriptionPop}>
			...
			<View style={styles.contentContainer}>
				...
				<Text color="muted" size="bodyBig" style={styles.regularFontFamily}>
					Your Talent Grid Pro subscription {data === 'cancelled_ended' ? ' has expired' : 'expires soon'}. Don’t lose access to exclusive features, restart subscription now!
				</Text>
