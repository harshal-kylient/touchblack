...
export default function InterestedProjects() {
	...
	const { data, isLoading, isFetching, refetch, hasNextPage, fetchNextPage } = useGetTalentProjects(EnumStatus.Tentative, clicked);
	...
	return (
		<View style={styles.container}>
			<Accordion title="Tentative Projects" onToggle={expanded => setClicked(expanded)}>
				<FlashList
					data={data}
