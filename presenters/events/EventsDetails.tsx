import { Dimensions, Image, Pressable, SafeAreaView, ScrollView, TouchableOpacity, View, Text as RNText } from 'react-native';
import { createStyleSheet, useStyles } from 'react-native-unistyles';
import { Share } from '@touchblack/icons';
...
function EventDetails({ route }) {
	...
	const handleSharePress = () => {
		...
		// 	await Share.share({
		// 		message: `Watch ${name}'s latest showreel, only on Talent Grid\n\nhttps://ttgd.in/${isProducer ? 'producer' : 'talent'}/${id}?platform=${platformType}`,
