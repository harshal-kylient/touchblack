...
function ProducerTeamMemberManagement({ userId, isNewMember, userName = 'Team member name', userRole = 'Team member role', profilePictureUrl }: ProducerTeamMemberManagementProps) {
