...
function BlackbookUserItem({ item, index, onPress }: IProps) {
	const { styles, theme } = useStyles(stylesheet);
	const bookmarkIconColor = darkTheme.colors.primary;
	const bookmarkStrokeColor = darkTheme.colors.primary;
...
export default BlackbookUserItem;
